...
export class DetailsComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        this.streamService.getListVideos(this.cours_actuel)
            ...
            .then(data => {
                ...
                this.video.nativeElement.setAttribute('src', `http://5:4100/${this.cours_actuel}/${data[0]}`);
    ...
    showVideo(video, index) {
        ...
        this.video.nativeElement.setAttribute('src', `http://nibaldonoso.fr:4100/${this.cours_actuel}/${this.listvideos[index]}`);
        ...
        this.video.nativeElement.addEventListener('timeupdate', () => {
            if (this.video.nativeElement.ended) {
                ...
                if (index < this.listvideos.length) {
                    ...
                    this.video.nativeElement.setAttribute('src', `http://nibaldonoso:4100/${this.cours_actuel}/${this.listvideos[index]}`);
                    this.video.nativeElement.volume = 0.05;
                    this.video.nativeElement.play();
                } else {
                    // console.log("terminé");
